...
const {
  NEXT_PUBLIC_SANITY_PROJECT_ID='9wa3roab', // Sanity project ID
  NEXT_PUBLIC_SANITY_DATASET='production', // Sanity dataset (e.g., "production")
  NEXT_PUBLIC_SANITY_AUTH_TOKEN='skFoA7Nl2RIkFnjwcRnJbWfn0HgQQcasHKZCn8HD3ccjxEPJcYBbT7nG8aZ7HjHP3e2pGHHESm3QyMWwSNbUP4SOMQ4qQfqEyK8T3UaXNWvuvNnSU9utvk2Skfl2zevUorGwwqCGLL1UQ5AoLVyjY2pi1jSz0vaRKQLdZqfIHzZ0cflWt49h', // Sanity API token
